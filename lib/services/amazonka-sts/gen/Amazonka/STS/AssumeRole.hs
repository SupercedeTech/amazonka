...
newAssumeRole pRoleArn_ pRoleSessionName_
  = AssumeRole'{tags = Prelude.Nothing,
...
instance Core.AWSRequest AssumeRole where
        ...
        response
          = Response.receiveXMLWrapper "AssumeRoleResult"
              (\ s h x ->
                 AssumeRoleResponse' Prelude.<$>
                   (x Core..@? "AssumedRoleUser") Prelude.<*>
                     (x Core..@? "SourceIdentity")
        ...
        toQuery AssumeRole'{..}
          = Prelude.mconcat
              ["Action" Core.=:
               ...
               "Policy" Core.=: policy,
               "TransitiveTagKeys" Core.=:
                 Core.toQuery
                   (Core.toQueryList "member" Prelude.<$>
                      transitiveTagKeys),
               "PolicyArns" Core.=:
                 Core.toQuery
