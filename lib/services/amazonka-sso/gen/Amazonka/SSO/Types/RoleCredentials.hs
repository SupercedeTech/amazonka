...
newRoleCredentials
    ...
    -> Core.SecretKey -- ^ 'secretAccessKey'
    -> RoleCredentials
newRoleCredentials pAccessKeyId_ pSecretAccessKey_
  = RoleCredentials'{expiration = Prelude.Nothing,
...
instance Core.FromJSON RoleCredentials where
        parseJSON
          = Core.withObject "RoleCredentials"
              (\ x ->
                 RoleCredentials' Prelude.<$>
                   (x Core..:? "expiration") Prelude.<*>
                     (x Core..:? "sessionToken")
