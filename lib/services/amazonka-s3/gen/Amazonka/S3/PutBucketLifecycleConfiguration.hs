...
newPutBucketLifecycleConfiguration pBucket_
  = PutBucketLifecycleConfiguration'{checksumAlgorithm
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           PutBucketLifecycleConfiguration
         where
        type AWSResponse PutBucketLifecycleConfiguration =
             PutBucketLifecycleConfigurationResponse
        request srv
...
instance Core.ToPath PutBucketLifecycleConfiguration
         where
        toPath PutBucketLifecycleConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery PutBucketLifecycleConfiguration
         where
        toQuery
