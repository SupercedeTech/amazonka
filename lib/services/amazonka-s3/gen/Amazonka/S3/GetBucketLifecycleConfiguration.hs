...
newGetBucketLifecycleConfiguration pBucket_
  = GetBucketLifecycleConfiguration'{expectedBucketOwner
                                       = Prelude.Nothing,
                                     bucket = pBucket_}
...
instance Core.AWSRequest
           GetBucketLifecycleConfiguration
         where
        type AWSResponse GetBucketLifecycleConfiguration =
             GetBucketLifecycleConfigurationResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketLifecycleConfigurationResponse' Prelude.<$>
                   (Core.may (Core.parseXMLList "Rule") x) Prelude.<*>
...
instance Core.ToPath GetBucketLifecycleConfiguration
         where
        toPath GetBucketLifecycleConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery GetBucketLifecycleConfiguration
         where
        toQuery
