...
newGetBucketInventoryConfiguration pBucket_ pId_
  = GetBucketInventoryConfiguration'{expectedBucketOwner
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           GetBucketInventoryConfiguration
         where
        type AWSResponse GetBucketInventoryConfiguration =
             GetBucketInventoryConfigurationResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketInventoryConfigurationResponse' Prelude.<$>
...
instance Core.ToPath GetBucketInventoryConfiguration
         where
        toPath GetBucketInventoryConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery GetBucketInventoryConfiguration
         where
