...
newPutBucketAnalyticsConfiguration
    ...
    -> AnalyticsConfiguration -- ^ 'analyticsConfiguration'
    -> PutBucketAnalyticsConfiguration
newPutBucketAnalyticsConfiguration pBucket_ pId_
  pAnalyticsConfiguration_
  = PutBucketAnalyticsConfiguration'{expectedBucketOwner
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           PutBucketAnalyticsConfiguration
         where
        type AWSResponse PutBucketAnalyticsConfiguration =
             PutBucketAnalyticsConfigurationResponse
        request srv
...
instance Core.ToPath PutBucketAnalyticsConfiguration
         where
        toPath PutBucketAnalyticsConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery PutBucketAnalyticsConfiguration
         where
