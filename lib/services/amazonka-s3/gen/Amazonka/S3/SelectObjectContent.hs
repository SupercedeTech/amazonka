...
newSelectObjectContent
    ...
    -> OutputSerialization -- ^ 'outputSerialization'
    -> SelectObjectContent
newSelectObjectContent pBucket_ pKey_ pExpression_
  pExpressionType_ pInputSerialization_
  pOutputSerialization_
  = SelectObjectContent'{expectedBucketOwner =
                           Prelude.Nothing,
                         ...
                         key = pKey_, expression = pExpression_,
...
instance Core.AWSRequest SelectObjectContent where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 SelectObjectContentResponse' Prelude.<$>
...
newSelectObjectContentResponse pHttpStatus_
  = SelectObjectContentResponse'{payload =
                                   Prelude.Nothing,
