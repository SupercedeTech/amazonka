...
newHeadObject pBucket_ pKey_
  = HeadObject'{expectedBucketOwner = Prelude.Nothing,
...
newHeadObjectResponse pHttpStatus_
  = HeadObjectResponse'{serverSideEncryption =
                          Prelude.Nothing,
...
instance Prelude.NFData HeadObjectResponse where
        rnf HeadObjectResponse'{..}
          = Prelude.rnf serverSideEncryption `Prelude.seq`
              Prelude.rnf partsCount `Prelude.seq`
                      ...
                      Prelude.rnf websiteRedirectLocation `Prelude.seq`
                        Prelude.rnf expiration `Prelude.seq`
                          Prelude.rnf requestCharged `Prelude.seq`
                            Prelude.rnf objectLockRetainUntilDate `Prelude.seq`
                                ...
                                Prelude.rnf replicationStatus `Prelude.seq`
                                  Prelude.rnf metadata `Prelude.seq`
                                    Prelude.rnf checksumCRC32 `Prelude.seq`
                                      Prelude.rnf restore `Prelude.seq`
