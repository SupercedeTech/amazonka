...
newCreateMultipartUpload pBucket_ pKey_
  = CreateMultipartUpload'{serverSideEncryption =
                             Prelude.Nothing,
...
instance Core.AWSRequest CreateMultipartUpload where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 CreateMultipartUploadResponse' Prelude.<$>
                            ...
                            Prelude.rnf acl `Prelude.seq`
                              Prelude.rnf expectedBucketOwner `Prelude.seq`
                                Prelude.rnf metadata `Prelude.seq`
                                  Prelude.rnf contentLanguage `Prelude.seq`
                                    Prelude.rnf sSEKMSKeyId `Prelude.seq`
                                      Prelude.rnf contentDisposition
                                        `Prelude.seq`
                                        Prelude.rnf objectLockLegalHoldStatus
                                          `Prelude.seq`
                                          Prelude.rnf requestPayer `Prelude.seq`
                                            Prelude.rnf sSEKMSEncryptionContext
                                              `Prelude.seq`
                                              Prelude.rnf grantRead
                                                `Prelude.seq`
...
newCreateMultipartUploadResponse pHttpStatus_
  pUploadId_
  = CreateMultipartUploadResponse'{serverSideEncryption
                                     = Prelude.Nothing,
                                   checksumAlgorithm = Prelude.Nothing,
                                   key = Prelude.Nothing,
                                   bucketKeyEnabled = Prelude.Nothing,
