...
newPutBucketNotificationConfiguration
    ...
    -> NotificationConfiguration -- ^ 'notificationConfiguration'
    -> PutBucketNotificationConfiguration
newPutBucketNotificationConfiguration pBucket_
  pNotificationConfiguration_
  = PutBucketNotificationConfiguration'{expectedBucketOwner
                                          = Prelude.Nothing,
...
instance Core.AWSRequest
           PutBucketNotificationConfiguration
         where
        type AWSResponse PutBucketNotificationConfiguration =
             PutBucketNotificationConfigurationResponse
        request srv
        ...
        toHeaders PutBucketNotificationConfiguration'{..}
          = Prelude.mconcat
              ["x-amz-expected-bucket-owner" Core.=#
                 expectedBucketOwner,
               "x-amz-skip-destination-validation" Core.=#
                 skipDestinationValidation]
