...
newPutBucketOwnershipControls
    ...
    -> OwnershipControls -- ^ 'ownershipControls'
    -> PutBucketOwnershipControls
newPutBucketOwnershipControls pBucket_
  pOwnershipControls_
  = PutBucketOwnershipControls'{contentMD5 =
                                  Prelude.Nothing,
...
instance Core.AWSRequest PutBucketOwnershipControls
         where
        type AWSResponse PutBucketOwnershipControls =
             PutBucketOwnershipControlsResponse
        request srv
...
instance Core.AWSService PutBucketOwnershipControls
         where
...
instance Core.ToElement PutBucketOwnershipControls
         where
...
instance Core.ToHeaders PutBucketOwnershipControls
         where
...
instance Core.ToQuery PutBucketOwnershipControls
         where
        toQuery
          = Prelude.const
