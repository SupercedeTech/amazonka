...
newWriteGetObjectResponse
    :: Prelude.Text -- ^ 'requestRoute'
    -> Prelude.Text -- ^ 'requestToken'
    -> Core.RequestBody -- ^ 'body'
    -> WriteGetObjectResponse
newWriteGetObjectResponse pRequestRoute_
  pRequestToken_ pBody_
  = WriteGetObjectResponse'{serverSideEncryption =
                              Prelude.Nothing,
                            ...
                            requestToken = pRequestToken_, body = pBody_}
        ...
        toHeaders WriteGetObjectResponse'{..}
          = Prelude.mconcat
              ["x-amz-fwd-header-x-amz-server-side-encryption"
               ...
               "x-amz-fwd-header-x-amz-mp-parts-count" Core.=#
                 partsCount,
               "x-amz-fwd-header-x-amz-checksum-crc32c" Core.=#
                 checksumCRC32C,
               "x-amz-fwd-header-x-amz-object-lock-mode" Core.=#
                 objectLockMode,
               "x-amz-fwd-header-x-amz-server-side-encryption-bucket-key-enabled"
                 Core.=# bucketKeyEnabled,
               "x-amz-fwd-header-x-amz-expiration" Core.=#
                 expiration,
               "x-amz-fwd-header-x-amz-request-charged" Core.=#
                 requestCharged,
               "x-amz-fwd-header-x-amz-object-lock-retain-until-date"
                 Core.=# objectLockRetainUntilDate,
               "x-amz-fwd-header-x-amz-checksum-sha1" Core.=#
                 checksumSHA1,
               "x-amz-fwd-header-x-amz-replication-status" Core.=#
                 replicationStatus,
               "x-amz-fwd-error-message" Core.=# errorMessage,
               "x-amz-meta-" Core.=# metadata,
               "x-amz-fwd-header-x-amz-checksum-crc32" Core.=#
                 checksumCRC32,
               "x-amz-fwd-header-x-amz-restore" Core.=# restore,
               "x-amz-fwd-header-Content-Language" Core.=#
                 contentLanguage,
               "x-amz-fwd-header-x-amz-server-side-encryption-aws-kms-key-id"
                 Core.=# sSEKMSKeyId,
               "x-amz-fwd-header-Content-Disposition" Core.=#
                 contentDisposition,
               "x-amz-fwd-header-x-amz-object-lock-legal-hold"
                 Core.=# objectLockLegalHoldStatus,
               "x-amz-fwd-header-x-amz-checksum-sha256" Core.=#
                 checksumSHA256,
               "x-amz-fwd-header-accept-ranges" Core.=#
                 acceptRanges,
               "Content-Length" Core.=# contentLength,
               "x-amz-fwd-header-x-amz-tagging-count" Core.=#
                 tagCount,
               "x-amz-fwd-header-x-amz-server-side-encryption-customer-algorithm"
                 Core.=# sSECustomerAlgorithm,
               "x-amz-fwd-error-code" Core.=# errorCode,
               "x-amz-fwd-header-Content-Range" Core.=#
                 contentRange,
               "x-amz-fwd-header-Last-Modified" Core.=#
                 lastModified,
               "x-amz-fwd-header-Cache-Control" Core.=#
                 cacheControl,
               "x-amz-fwd-header-Content-Encoding" Core.=#
                 contentEncoding,
               "x-amz-fwd-header-x-amz-missing-meta" Core.=#
                 missingMeta,
               ...
               "x-amz-fwd-header-x-amz-storage-class" Core.=#
                 storageClass,
               "x-amz-fwd-status" Core.=# statusCode,
               "x-amz-fwd-header-ETag" Core.=# eTag,
               "x-amz-fwd-header-x-amz-delete-marker" Core.=#
                 deleteMarker,
               "x-amz-fwd-header-Content-Type" Core.=# contentType,
               "x-amz-fwd-header-x-amz-version-id" Core.=#
                 versionId,
