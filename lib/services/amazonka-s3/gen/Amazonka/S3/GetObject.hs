...
newGetObject pBucket_ pKey_
  = GetObject'{responseCacheControl = Prelude.Nothing,
              ...
              (\ s h x ->
                 GetObjectResponse' Prelude.<$>
                   (h Core..#? "x-amz-server-side-encryption")
                     ...
                     Prelude.<*>
                     (h Core..#? "x-amz-website-redirect-location")
                     Prelude.<*> (h Core..#? "x-amz-expiration")
                     Prelude.<*> (h Core..#? "x-amz-request-charged")
                     Prelude.<*>
                     (h Core..#? "x-amz-object-lock-retain-until-date")
                     ...
                     Prelude.<*>
                     (h Core..#? "x-amz-object-lock-legal-hold")
                          ...
                          Prelude.rnf sSECustomerAlgorithm `Prelude.seq`
                            Prelude.rnf checksumMode `Prelude.seq`
                              Prelude.rnf sSECustomerKeyMD5 `Prelude.seq`
                                Prelude.rnf responseContentLanguage
                                  `Prelude.seq`
                                  Prelude.rnf responseExpires `Prelude.seq`
                                    Prelude.rnf responseContentEncoding
                                      `Prelude.seq`
                                      Prelude.rnf ifMatch `Prelude.seq`
                                        Prelude.rnf ifModifiedSince
                                          `Prelude.seq`
...
newGetObjectResponse pHttpStatus_ pBody_
  = GetObjectResponse'{serverSideEncryption =
                         Prelude.Nothing,
                       ...
                       versionId = Prelude.Nothing,
                       httpStatus = pHttpStatus_, body = pBody_}
