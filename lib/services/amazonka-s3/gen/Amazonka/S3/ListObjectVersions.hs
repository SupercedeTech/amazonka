...
newListObjectVersions pBucket_
  = ListObjectVersions'{maxKeys = Prelude.Nothing,
                        expectedBucketOwner = Prelude.Nothing,
                        keyMarker = Prelude.Nothing,
                        delimiter = Prelude.Nothing,
                        prefix = Prelude.Nothing,
                        encodingType = Prelude.Nothing,
                        versionIdMarker = Prelude.Nothing, bucket = pBucket_}
...
instance Core.AWSPager ListObjectVersions where
        page rq rs
          | Core.stop
              (rs Lens.^?
                 listObjectVersionsResponse_isTruncated Prelude..
                   Lens._Just)
            = Prelude.Nothing
          | Prelude.isNothing
              (rs Lens.^?
                 listObjectVersionsResponse_nextKeyMarker Prelude..
                   Lens._Just)
              Prelude.&&
              Prelude.isNothing
                (rs Lens.^?
          ...
          | Prelude.otherwise =
            Prelude.Just Prelude.$ rq Prelude.&
              listObjectVersions_keyMarker Lens..~
                rs Lens.^?
                  listObjectVersionsResponse_nextKeyMarker Prelude..
                    Lens._Just
              Prelude.&
              listObjectVersions_versionIdMarker Lens..~
                rs Lens.^?
                  listObjectVersionsResponse_nextVersionIdMarker
                    Prelude.. Lens._Just
...
instance Core.AWSRequest ListObjectVersions where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListObjectVersionsResponse' Prelude.<$>
                   (x Core..@? "MaxKeys") Prelude.<*>
                     ...
                     Prelude.<*>
                     (Core.may (Core.parseXMLList "DeleteMarker") x)
                     Prelude.<*> (x Core..@? "Delimiter")
                     Prelude.<*>
                     (Core.may (Core.parseXMLList "Version") x)
...
newListObjectVersionsResponse pHttpStatus_
  = ListObjectVersionsResponse'{maxKeys =
                                  Prelude.Nothing,
