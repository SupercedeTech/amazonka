...
newObjectNotExists
  = Core.Wait{Core._waitName = "ObjectNotExists",
              Core._waitAttempts = 20, Core._waitDelay = 5,
              Core._waitAcceptors =
...
newObjectExists
  = Core.Wait{Core._waitName = "ObjectExists",
              Core._waitAttempts = 20, Core._waitDelay = 5,
              Core._waitAcceptors =
...
newBucketNotExists
  = Core.Wait{Core._waitName = "BucketNotExists",
              Core._waitAttempts = 20, Core._waitDelay = 5,
              Core._waitAcceptors =
                [Core.matchStatus 404 Core.AcceptSuccess]}
...
newBucketExists
  = Core.Wait{Core._waitName = "BucketExists",
              Core._waitAttempts = 20, Core._waitDelay = 5,
              Core._waitAcceptors =
                [Core.matchStatus 200 Core.AcceptSuccess,
