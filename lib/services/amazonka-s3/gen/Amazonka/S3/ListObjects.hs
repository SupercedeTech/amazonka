...
newListObjects pBucket_
  = ListObjects'{maxKeys = Prelude.Nothing,
...
instance Core.AWSPager ListObjects where
        page rq rs
          | Core.stop
              (rs Lens.^?
                 listObjectsResponse_isTruncated Prelude.. Lens._Just)
            = Prelude.Nothing
          | Prelude.isNothing
              (rs Lens.^.
                 Core.choice
                   (Lens.^?
                      (listObjectsResponse_nextMarker Prelude..
                         Lens._Just))
                   (Lens.^?
...
instance Core.ToQuery ListObjects where
        toQuery ListObjects'{..}
          = Prelude.mconcat
              ["max-keys" Core.=: maxKeys, "marker" Core.=: marker,
...
newListObjectsResponse pHttpStatus_
  = ListObjectsResponse'{maxKeys = Prelude.Nothing,
                         commonPrefixes = Prelude.Nothing,
                         name = Prelude.Nothing, marker = Prelude.Nothing,
