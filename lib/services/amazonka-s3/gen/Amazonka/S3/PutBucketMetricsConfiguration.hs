...
newPutBucketMetricsConfiguration
    ...
    -> MetricsConfiguration -- ^ 'metricsConfiguration'
    -> PutBucketMetricsConfiguration
newPutBucketMetricsConfiguration pBucket_ pId_
  pMetricsConfiguration_
  = PutBucketMetricsConfiguration'{expectedBucketOwner
                                     = Prelude.Nothing,
                                   bucket = pBucket_, id = pId_,
...
instance Core.AWSRequest
           PutBucketMetricsConfiguration
         where
        type AWSResponse PutBucketMetricsConfiguration =
             PutBucketMetricsConfigurationResponse
        request srv
...
instance Core.ToElement PutBucketMetricsConfiguration
         where
...
instance Core.ToHeaders PutBucketMetricsConfiguration
         where
...
instance Core.ToPath PutBucketMetricsConfiguration
         where
        toPath PutBucketMetricsConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery PutBucketMetricsConfiguration
         where
