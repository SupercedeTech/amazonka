...
newDeleteBucketReplication pBucket_
  = DeleteBucketReplication'{expectedBucketOwner =
                               Prelude.Nothing,
                             bucket = pBucket_}
...
instance Core.AWSRequest DeleteBucketReplication
         where
        type AWSResponse DeleteBucketReplication =
             DeleteBucketReplicationResponse
        request srv
...
instance Core.AWSService DeleteBucketReplication
         where
