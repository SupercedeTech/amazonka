...
newGetObjectAttributes pBucket_ pKey_
  = GetObjectAttributes'{expectedBucketOwner =
                           Prelude.Nothing,
                         ...
                         key = pKey_, objectAttributes = Prelude.mempty}
...
instance Core.AWSRequest GetObjectAttributes where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetObjectAttributesResponse' Prelude.<$>
...
newGetObjectAttributesResponse pHttpStatus_
  = GetObjectAttributesResponse'{requestCharged =
                                   Prelude.Nothing,
