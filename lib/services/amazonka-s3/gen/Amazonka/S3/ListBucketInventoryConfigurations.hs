...
newListBucketInventoryConfigurations pBucket_
  = ListBucketInventoryConfigurations'{expectedBucketOwner
                                         = Prelude.Nothing,
...
instance Core.AWSRequest
           ListBucketInventoryConfigurations
         where
        type AWSResponse ListBucketInventoryConfigurations =
             ListBucketInventoryConfigurationsResponse
        request srv
...
newListBucketInventoryConfigurationsResponse
  pHttpStatus_
  = ListBucketInventoryConfigurationsResponse'{inventoryConfigurationList
                                                 = Prelude.Nothing,
...
instance Prelude.NFData
        ...
        rnf ListBucketInventoryConfigurationsResponse'{..}
          = Prelude.rnf inventoryConfigurationList
              `Prelude.seq`
