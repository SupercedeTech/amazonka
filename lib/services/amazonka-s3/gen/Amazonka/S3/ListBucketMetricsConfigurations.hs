...
newListBucketMetricsConfigurations pBucket_
  = ListBucketMetricsConfigurations'{expectedBucketOwner
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           ListBucketMetricsConfigurations
         where
        type AWSResponse ListBucketMetricsConfigurations =
             ListBucketMetricsConfigurationsResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListBucketMetricsConfigurationsResponse' Prelude.<$>
                   (Core.may (Core.parseXMLList "MetricsConfiguration")
                      x)
...
instance Core.ToPath ListBucketMetricsConfigurations
         where
        toPath ListBucketMetricsConfigurations'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery ListBucketMetricsConfigurations
         where
...
newListBucketMetricsConfigurationsResponse
  pHttpStatus_
  = ListBucketMetricsConfigurationsResponse'{metricsConfigurationList
                                               = Prelude.Nothing,
