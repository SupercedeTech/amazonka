...
newDeleteBucketMetricsConfiguration pBucket_ pId_
  = DeleteBucketMetricsConfiguration'{expectedBucketOwner
                                        = Prelude.Nothing,
...
instance Core.AWSRequest
           DeleteBucketMetricsConfiguration
         where
        type AWSResponse DeleteBucketMetricsConfiguration =
             DeleteBucketMetricsConfigurationResponse
        request srv
...
instance Core.ToPath DeleteBucketMetricsConfiguration
         where
