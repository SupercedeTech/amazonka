...
newS3ServiceError
    :: S3ServiceError
newS3ServiceError
  = S3ServiceError'{key = Prelude.Nothing,
                    message = Prelude.Nothing, code = Prelude.Nothing,
...
instance Core.FromXML S3ServiceError where
        parseXML x
          = S3ServiceError' Prelude.<$>
              (x Core..@? "Key") Prelude.<*> (x Core..@? "Message")
                Prelude.<*> (x Core..@? "Code")
        ...
        rnf S3ServiceError'{..}
          = Prelude.rnf key `Prelude.seq`
              Prelude.rnf message `Prelude.seq`
                Prelude.rnf code `Prelude.seq` Prelude.rnf versionId
