...
newIntelligentTieringFilter
  = IntelligentTieringFilter'{tag = Prelude.Nothing,
                              prefix = Prelude.Nothing, and = Prelude.Nothing}
...
instance Core.FromXML IntelligentTieringFilter where
        parseXML x
          = IntelligentTieringFilter' Prelude.<$>
              (x Core..@? "Tag") Prelude.<*> (x Core..@? "Prefix")
                Prelude.<*> (x Core..@? "And")
