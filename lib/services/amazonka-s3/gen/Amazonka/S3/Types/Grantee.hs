...
newGrantee
    ...
    -> Grantee
newGrantee pType_
  = Grantee'{displayName = Prelude.Nothing,
             uri = Prelude.Nothing, id = Prelude.Nothing,
             emailAddress = Prelude.Nothing, type' = pType_}
