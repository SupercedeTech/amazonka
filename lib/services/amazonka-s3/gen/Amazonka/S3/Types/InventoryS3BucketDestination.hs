...
newInventoryS3BucketDestination pBucket_ pFormat_
  = InventoryS3BucketDestination'{accountId =
                                  ...
                                  prefix = Prelude.Nothing, bucket = pBucket_,
                                  format = pFormat_}
...
instance Core.FromXML InventoryS3BucketDestination
         where
        parseXML x
          = InventoryS3BucketDestination' Prelude.<$>
              (x Core..@? "AccountId") Prelude.<*>
                (x Core..@? "Encryption")
          ...
          = Prelude.rnf accountId `Prelude.seq`
              Prelude.rnf encryption `Prelude.seq`
                Prelude.rnf prefix `Prelude.seq`
                  Prelude.rnf bucket `Prelude.seq` Prelude.rnf format

instance Core.ToXML InventoryS3BucketDestination
         where
        toXML InventoryS3BucketDestination'{..}
          = Prelude.mconcat
              ["AccountId" Core.@= accountId,
               "Encryption" Core.@= encryption,
               "Prefix" Core.@= prefix, "Bucket" Core.@= bucket,
               "Format" Core.@= format]
