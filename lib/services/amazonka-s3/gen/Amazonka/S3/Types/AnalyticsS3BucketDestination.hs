...
newAnalyticsS3BucketDestination pFormat_ pBucket_
  = AnalyticsS3BucketDestination'{bucketAccountId =
                                    Prelude.Nothing,
                                  prefix = Prelude.Nothing, format = pFormat_,
                                  bucket = pBucket_}
...
instance Core.FromXML AnalyticsS3BucketDestination
         where
        parseXML x
          = AnalyticsS3BucketDestination' Prelude.<$>
              (x Core..@? "BucketAccountId") Prelude.<*>
                (x Core..@? "Prefix")
        ...
        rnf AnalyticsS3BucketDestination'{..}
          = Prelude.rnf bucketAccountId `Prelude.seq`
              Prelude.rnf prefix `Prelude.seq`
                Prelude.rnf format `Prelude.seq` Prelude.rnf bucket

instance Core.ToXML AnalyticsS3BucketDestination
         where
        toXML AnalyticsS3BucketDestination'{..}
          = Prelude.mconcat
              ["BucketAccountId" Core.@= bucketAccountId,
               "Prefix" Core.@= prefix, "Format" Core.@= format,
               "Bucket" Core.@= bucket]
