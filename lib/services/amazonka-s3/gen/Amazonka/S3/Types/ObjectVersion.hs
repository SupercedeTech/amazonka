...
newObjectVersion
    :: ObjectVersion
newObjectVersion
  = ObjectVersion'{checksumAlgorithm = Prelude.Nothing,
                   key = Prelude.Nothing, isLatest = Prelude.Nothing,
                   size = Prelude.Nothing, owner = Prelude.Nothing,
                    ...
                    Prelude.rnf owner `Prelude.seq`
                      Prelude.rnf lastModified `Prelude.seq`
                        Prelude.rnf storageClass `Prelude.seq`
                          Prelude.rnf eTag `Prelude.seq` Prelude.rnf versionId
