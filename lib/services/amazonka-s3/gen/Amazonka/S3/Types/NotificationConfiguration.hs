...
instance Core.FromXML NotificationConfiguration where
        parseXML x
          = NotificationConfiguration' Prelude.<$>
              (x Core..@? "EventBridgeConfiguration") Prelude.<*>
                (Core.may (Core.parseXMLList "QueueConfiguration") x)
                Prelude.<*>
                (Core.may (Core.parseXMLList "TopicConfiguration") x)
                Prelude.<*>
                (Core.may
        ...
        rnf NotificationConfiguration'{..}
          = Prelude.rnf eventBridgeConfiguration `Prelude.seq`
              Prelude.rnf queueConfigurations `Prelude.seq`
                Prelude.rnf topicConfigurations `Prelude.seq`
                  Prelude.rnf lambdaFunctionConfigurations

instance Core.ToXML NotificationConfiguration where
        toXML NotificationConfiguration'{..}
          = Prelude.mconcat
              ["EventBridgeConfiguration" Core.@=
                 eventBridgeConfiguration,
               Core.toXML
                 (Core.toXMLList "QueueConfiguration" Prelude.<$>
                    queueConfigurations),
               Core.toXML
                 (Core.toXMLList "TopicConfiguration" Prelude.<$>
                    topicConfigurations),
               Core.toXML
