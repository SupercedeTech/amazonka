...
-- |
-- Module      : Amazonka.S3.Types.DeleteMarkerReplicationStatus
...
newtype DeleteMarkerReplicationStatus = DeleteMarkerReplicationStatus'{fromDeleteMarkerReplicationStatus
                                                                       ::
                                                                       Core.Text}
  deriving stock
      ( Prelude.Show
