...
newInventoryConfiguration
    ...
    -> Prelude.Bool -- ^ 'isEnabled'
    -> Prelude.Text -- ^ 'id'
    -> InventoryIncludedObjectVersions -- ^ 'includedObjectVersions'
    -> InventorySchedule -- ^ 'schedule'
    -> InventoryConfiguration
newInventoryConfiguration pDestination_ pIsEnabled_
  pId_ pIncludedObjectVersions_ pSchedule_
  = InventoryConfiguration'{optionalFields =
                              Prelude.Nothing,
                            filter' = Prelude.Nothing,
                            destination = pDestination_,
                            isEnabled = pIsEnabled_, id = pId_,
...
instance Core.FromXML InventoryConfiguration where
        parseXML x
          = InventoryConfiguration' Prelude.<$>
              (x Core..@? "OptionalFields" Core..!@ Prelude.mempty
        ...
        toXML InventoryConfiguration'{..}
          = Prelude.mconcat
              ["OptionalFields" Core.@=
               ...
               "IsEnabled" Core.@= isEnabled, "Id" Core.@= id,
               "IncludedObjectVersions" Core.@=
