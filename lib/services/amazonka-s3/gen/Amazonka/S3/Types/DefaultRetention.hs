...
newDefaultRetention
    :: DefaultRetention
newDefaultRetention
  = DefaultRetention'{days = Prelude.Nothing,
                      years = Prelude.Nothing, mode = Prelude.Nothing}
...
instance Core.FromXML DefaultRetention where
        parseXML x
          = DefaultRetention' Prelude.<$>
              (x Core..@? "Days") Prelude.<*> (x Core..@? "Years")
                Prelude.<*> (x Core..@? "Mode")
...
instance Prelude.NFData DefaultRetention where
        rnf DefaultRetention'{..}
          = Prelude.rnf days `Prelude.seq`
              Prelude.rnf years `Prelude.seq` Prelude.rnf mode

instance Core.ToXML DefaultRetention where
        toXML DefaultRetention'{..}
          = Prelude.mconcat
              ["Days" Core.@= days, "Years" Core.@= years,
               "Mode" Core.@= mode]
