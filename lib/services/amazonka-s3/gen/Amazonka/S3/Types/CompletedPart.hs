              ...
              Prelude.rnf checksumSHA1 `Prelude.seq`
                Prelude.rnf checksumCRC32 `Prelude.seq`
                  Prelude.rnf checksumSHA256 `Prelude.seq`
                    Prelude.rnf partNumber `Prelude.seq` Prelude.rnf eTag
        ...
        toXML CompletedPart'{..}
          = Prelude.mconcat
              ["ChecksumCRC32C" Core.@= checksumCRC32C,
               ...
               "PartNumber" Core.@= partNumber, "ETag" Core.@= eTag]
