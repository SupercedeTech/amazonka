...
newLambdaFunctionConfiguration
    :: Prelude.Text -- ^ 'lambdaFunctionArn'
    -> LambdaFunctionConfiguration
newLambdaFunctionConfiguration pLambdaFunctionArn_
  = LambdaFunctionConfiguration'{id = Prelude.Nothing,
...
instance Core.FromXML LambdaFunctionConfiguration
         where
        parseXML x
          = LambdaFunctionConfiguration' Prelude.<$>
