...
newGetObjectAttributesParts
  = GetObjectAttributesParts'{parts = Prelude.Nothing,
...
instance Core.FromXML GetObjectAttributesParts where
        parseXML x
          = GetObjectAttributesParts' Prelude.<$>
              (Core.may (Core.parseXMLList "Part") x) Prelude.<*>
                (x Core..@? "NextPartNumberMarker")
                Prelude.<*> (x Core..@? "IsTruncated")
                Prelude.<*> (x Core..@? "PartsCount")
                Prelude.<*> (x Core..@? "MaxParts")
                Prelude.<*> (x Core..@? "PartNumberMarker")

instance Prelude.Hashable GetObjectAttributesParts
         where
...
instance Prelude.NFData GetObjectAttributesParts
         where
          ...
          = Prelude.rnf parts `Prelude.seq`
              Prelude.rnf nextPartNumberMarker `Prelude.seq`
                Prelude.rnf isTruncated `Prelude.seq`
                  Prelude.rnf totalPartsCount `Prelude.seq`
                    Prelude.rnf maxParts `Prelude.seq`
                      Prelude.rnf partNumberMarker
