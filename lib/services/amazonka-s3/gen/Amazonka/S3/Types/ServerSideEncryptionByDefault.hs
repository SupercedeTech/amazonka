...
instance Core.FromXML ServerSideEncryptionByDefault
         where
        parseXML x
          = ServerSideEncryptionByDefault' Prelude.<$>
              (x Core..@? "KMSMasterKeyID") Prelude.<*>
                (x Core..@ "SSEAlgorithm")
...
instance Core.ToXML ServerSideEncryptionByDefault
         where
