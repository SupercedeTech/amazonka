...
newLifecycleExpiration
  = LifecycleExpiration'{expiredObjectDeleteMarker =
                           Prelude.Nothing,
                         date = Prelude.Nothing, days = Prelude.Nothing}
...
instance Core.FromXML LifecycleExpiration where
        parseXML x
          = LifecycleExpiration' Prelude.<$>
              (x Core..@? "ExpiredObjectDeleteMarker") Prelude.<*>
                (x Core..@? "Date")
                Prelude.<*> (x Core..@? "Days")
...
instance Prelude.NFData LifecycleExpiration where
        rnf LifecycleExpiration'{..}
          = Prelude.rnf expiredObjectDeleteMarker `Prelude.seq`
              Prelude.rnf date `Prelude.seq` Prelude.rnf days
