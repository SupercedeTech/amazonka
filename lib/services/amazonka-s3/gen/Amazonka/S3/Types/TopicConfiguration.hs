...
newTopicConfiguration
    :: Prelude.Text -- ^ 'topicArn'
    -> TopicConfiguration
newTopicConfiguration pTopicArn_
  = TopicConfiguration'{id = Prelude.Nothing,
                        filter' = Prelude.Nothing, topicArn = pTopicArn_,
        ...
        rnf TopicConfiguration'{..}
          = Prelude.rnf id `Prelude.seq`
              Prelude.rnf filter' `Prelude.seq`
                Prelude.rnf topicArn `Prelude.seq` Prelude.rnf events
