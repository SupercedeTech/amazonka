...
instance Core.FromXML IntelligentTieringConfiguration
         where
        parseXML x
          = IntelligentTieringConfiguration' Prelude.<$>
        ...
        rnf IntelligentTieringConfiguration'{..}
          = Prelude.rnf filter' `Prelude.seq`
              Prelude.rnf id `Prelude.seq`
                Prelude.rnf status `Prelude.seq` Prelude.rnf tierings

instance Core.ToXML IntelligentTieringConfiguration
         where
