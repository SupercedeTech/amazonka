...
newSelectObjectContentEventStream
  = SelectObjectContentEventStream'{progress =
                                      Prelude.Nothing,
...
instance Core.FromXML SelectObjectContentEventStream
         where
        parseXML x
          = SelectObjectContentEventStream' Prelude.<$>
              (x Core..@? "Progress") Prelude.<*>
                (x Core..@? "Records")
          ...
          = Prelude.rnf progress `Prelude.seq`
              Prelude.rnf records `Prelude.seq`
                Prelude.rnf stats `Prelude.seq`
                  Prelude.rnf end `Prelude.seq` Prelude.rnf cont
