...
newLifecycleRule pStatus_
  = LifecycleRule'{transitions = Prelude.Nothing,
                   expiration = Prelude.Nothing, id = Prelude.Nothing,
                   ...
                   prefix = Prelude.Nothing, status = pStatus_}
...
instance Core.FromXML LifecycleRule where
        parseXML x
          = LifecycleRule' Prelude.<$>
              (Core.may (Core.parseXMLList "Transition") x)
                Prelude.<*> (x Core..@? "Expiration")
                Prelude.<*> (x Core..@? "ID")
                Prelude.<*>
                (x Core..@? "NoncurrentVersionExpiration")
                ...
                Prelude.rnf id `Prelude.seq`
                  Prelude.rnf noncurrentVersionExpiration `Prelude.seq`
                    Prelude.rnf filter' `Prelude.seq`
                      Prelude.rnf noncurrentVersionTransitions
                        `Prelude.seq`
                        Prelude.rnf abortIncompleteMultipartUpload
                          `Prelude.seq`
                          Prelude.rnf prefix `Prelude.seq` Prelude.rnf status

instance Core.ToXML LifecycleRule where
        toXML LifecycleRule'{..}
          = Prelude.mconcat
              [Core.toXML
                 (Core.toXMLList "Transition" Prelude.<$>
                    transitions),
               "Expiration" Core.@= expiration, "ID" Core.@= id,
               ...
               "Prefix" Core.@= prefix, "Status" Core.@= status]
