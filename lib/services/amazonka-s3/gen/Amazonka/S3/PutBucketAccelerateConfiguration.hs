...
newPutBucketAccelerateConfiguration
    ...
    -> AccelerateConfiguration -- ^ 'accelerateConfiguration'
    -> PutBucketAccelerateConfiguration
newPutBucketAccelerateConfiguration pBucket_
  pAccelerateConfiguration_
  = PutBucketAccelerateConfiguration'{checksumAlgorithm
                                        = Prelude.Nothing,
...
instance Core.AWSRequest
           PutBucketAccelerateConfiguration
         where
        type AWSResponse PutBucketAccelerateConfiguration =
             PutBucketAccelerateConfigurationResponse
        request srv
...
instance Core.ToPath PutBucketAccelerateConfiguration
         where
