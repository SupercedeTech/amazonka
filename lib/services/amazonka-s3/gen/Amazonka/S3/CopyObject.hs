...
newCopyObject
    :: BucketName -- ^ 'bucket'
    -> Prelude.Text -- ^ 'copySource'
    -> ObjectKey -- ^ 'key'
    -> CopyObject
newCopyObject pBucket_ pCopySource_ pKey_
  = CopyObject'{copySourceIfNoneMatch =
                  Prelude.Nothing,
                ...
                copySource = pCopySource_, key = pKey_}
              ...
              (\ s h x ->
                 CopyObjectResponse' Prelude.<$>
                   (h Core..#? "x-amz-server-side-encryption")
                     ...
                     Prelude.<*>
                     (h Core..#? "x-amz-copy-source-version-id")
                ...
                Prelude.rnf checksumAlgorithm `Prelude.seq`
                  Prelude.rnf copySourceSSECustomerKey `Prelude.seq`
                    Prelude.rnf copySourceSSECustomerKeyMD5 `Prelude.seq`
                      Prelude.rnf objectLockMode `Prelude.seq`
                        Prelude.rnf bucketKeyEnabled `Prelude.seq`
                          Prelude.rnf websiteRedirectLocation `Prelude.seq`
                            Prelude.rnf grantWriteACP `Prelude.seq`
                              Prelude.rnf objectLockRetainUntilDate
                                `Prelude.seq`
                                Prelude.rnf grantFullControl `Prelude.seq`
                                  Prelude.rnf acl `Prelude.seq`
                                    Prelude.rnf copySourceSSECustomerAlgorithm
                                      `Prelude.seq`
                                      Prelude.rnf expectedBucketOwner
                                        `Prelude.seq`
                                        Prelude.rnf metadata `Prelude.seq`
                                          Prelude.rnf contentLanguage
                                            `Prelude.seq`
                                            Prelude.rnf
                                              ...
                                              Prelude.rnf sSEKMSKeyId
                                                `Prelude.seq`
                                                Prelude.rnf contentDisposition
                                                  `Prelude.seq`
                                                  Prelude.rnf
...
instance Core.ToHeaders CopyObject where
        toHeaders CopyObject'{..}
          = Prelude.mconcat
              ["x-amz-copy-source-if-none-match" Core.=#
               ...
               "x-amz-copy-source-if-modified-since" Core.=#
                 copySourceIfModifiedSince,
               ...
               "x-amz-copy-source-if-unmodified-since" Core.=#
                 copySourceIfUnmodifiedSince,
               "x-amz-source-expected-bucket-owner" Core.=#
                 expectedSourceBucketOwner,
               ...
               "x-amz-copy-source-if-match" Core.=#
                 copySourceIfMatch,
...
newCopyObjectResponse pHttpStatus_
  = CopyObjectResponse'{serverSideEncryption =
                          Prelude.Nothing,
                        bucketKeyEnabled = Prelude.Nothing,
