...
newGetBucketOwnershipControls pBucket_
  = GetBucketOwnershipControls'{expectedBucketOwner =
                                  Prelude.Nothing,
                                bucket = pBucket_}
...
instance Core.AWSRequest GetBucketOwnershipControls
         where
        type AWSResponse GetBucketOwnershipControls =
             GetBucketOwnershipControlsResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketOwnershipControlsResponse' Prelude.<$>
                   (Core.parseXML x) Prelude.<*>
                     (Prelude.pure (Prelude.fromEnum s)))

instance Core.AWSService GetBucketOwnershipControls
         where
...
instance Core.ToHeaders GetBucketOwnershipControls
         where
...
instance Core.ToQuery GetBucketOwnershipControls
         where
        toQuery
          = Prelude.const
