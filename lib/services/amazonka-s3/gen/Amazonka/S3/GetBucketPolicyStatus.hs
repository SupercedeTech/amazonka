...
newGetBucketPolicyStatus pBucket_
  = GetBucketPolicyStatus'{expectedBucketOwner =
                             Prelude.Nothing,
                           bucket = pBucket_}
...
instance Core.AWSRequest GetBucketPolicyStatus where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketPolicyStatusResponse' Prelude.<$>
                   (Core.parseXML x) Prelude.<*>
                     (Prelude.pure (Prelude.fromEnum s)))

instance Core.AWSService GetBucketPolicyStatus where
...
newGetBucketPolicyStatusResponse pHttpStatus_
  = GetBucketPolicyStatusResponse'{policyStatus =
                                     Prelude.Nothing,
