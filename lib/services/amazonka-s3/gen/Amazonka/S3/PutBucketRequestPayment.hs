...
newPutBucketRequestPayment
    ...
    -> RequestPaymentConfiguration -- ^ 'requestPaymentConfiguration'
    -> PutBucketRequestPayment
newPutBucketRequestPayment pBucket_
  pRequestPaymentConfiguration_
  = PutBucketRequestPayment'{checksumAlgorithm =
                               Prelude.Nothing,
...
instance Core.AWSRequest PutBucketRequestPayment
         where
        type AWSResponse PutBucketRequestPayment =
             PutBucketRequestPaymentResponse
        request srv
...
instance Core.AWSService PutBucketRequestPayment
         where
