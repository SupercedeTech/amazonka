...
newUploadPart
    ...
    -> UploadPart
newUploadPart pBucket_ pKey_ pPartNumber_ pUploadId_
  pBody_
  = UploadPart'{checksumAlgorithm = Prelude.Nothing,
                ...
                key = pKey_, partNumber = pPartNumber_,
                uploadId = pUploadId_, body = pBody_}
...
newUploadPartResponse pHttpStatus_
  = UploadPartResponse'{serverSideEncryption =
                          Prelude.Nothing,
                        checksumCRC32C = Prelude.Nothing,
                        ...
                        sSECustomerAlgorithm = Prelude.Nothing,
                        sSECustomerKeyMD5 = Prelude.Nothing,
                        eTag = Prelude.Nothing, httpStatus = pHttpStatus_}
