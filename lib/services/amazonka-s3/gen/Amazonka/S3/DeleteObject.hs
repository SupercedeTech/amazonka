...
newDeleteObject pBucket_ pKey_
  = DeleteObject'{expectedBucketOwner =
                    Prelude.Nothing,
                  requestPayer = Prelude.Nothing,
                  bypassGovernanceRetention = Prelude.Nothing,
                  mfa = Prelude.Nothing, versionId = Prelude.Nothing,
...
instance Core.AWSRequest DeleteObject where
        ...
        response
          = Response.receiveEmpty
              (\ s h x ->
                 DeleteObjectResponse' Prelude.<$>
                   (h Core..#? "x-amz-request-charged") Prelude.<*>
                     (h Core..#? "x-amz-delete-marker")
...
newDeleteObjectResponse pHttpStatus_
  = DeleteObjectResponse'{requestCharged =
                            Prelude.Nothing,
