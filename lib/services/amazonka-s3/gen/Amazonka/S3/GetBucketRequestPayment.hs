...
newGetBucketRequestPayment pBucket_
  = GetBucketRequestPayment'{expectedBucketOwner =
                               Prelude.Nothing,
                             bucket = pBucket_}
...
instance Core.AWSRequest GetBucketRequestPayment
         where
        type AWSResponse GetBucketRequestPayment =
             GetBucketRequestPaymentResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketRequestPaymentResponse' Prelude.<$>
                   (x Core..@? "Payer") Prelude.<*>
                     (Prelude.pure (Prelude.fromEnum s)))

instance Core.AWSService GetBucketRequestPayment
         where
...
newGetBucketRequestPaymentResponse pHttpStatus_
  = GetBucketRequestPaymentResponse'{payer =
                                       Prelude.Nothing,
