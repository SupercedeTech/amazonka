...
newListParts pBucket_ pKey_ pUploadId_
  = ListParts'{expectedBucketOwner = Prelude.Nothing,
...
instance Core.AWSPager ListParts where
        page rq rs
          | Core.stop
              (rs Lens.^?
                 listPartsResponse_isTruncated Prelude.. Lens._Just)
            = Prelude.Nothing
          | Prelude.isNothing
              (rs Lens.^?
                 listPartsResponse_nextPartNumberMarker Prelude..
                   Lens._Just)
            = Prelude.Nothing
          | Prelude.otherwise =
            Prelude.Just Prelude.$ rq Prelude.&
              listParts_partNumberMarker Lens..~
                rs Lens.^?
                  listPartsResponse_nextPartNumberMarker Prelude..
                    Lens._Just
...
instance Core.AWSRequest ListParts where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListPartsResponse' Prelude.<$>
                   (x Core..@? "ChecksumAlgorithm") Prelude.<*>
                     (x Core..@? "UploadId")
                     Prelude.<*> (x Core..@? "Key")
                      ...
                      Prelude.rnf partNumberMarker `Prelude.seq`
                        Prelude.rnf sSECustomerKey `Prelude.seq`
                          Prelude.rnf bucket `Prelude.seq`
                            Prelude.rnf key `Prelude.seq` Prelude.rnf uploadId
...
newListPartsResponse pHttpStatus_
  = ListPartsResponse'{checksumAlgorithm =
                         Prelude.Nothing,
                       uploadId = Prelude.Nothing, key = Prelude.Nothing,
                       requestCharged = Prelude.Nothing,
                       parts = Prelude.Nothing, bucket = Prelude.Nothing,
                       abortRuleId = Prelude.Nothing,
                       nextPartNumberMarker = Prelude.Nothing,
                       isTruncated = Prelude.Nothing,
                       owner = Prelude.Nothing, abortDate = Prelude.Nothing,
                       maxParts = Prelude.Nothing,
                       partNumberMarker = Prelude.Nothing,
