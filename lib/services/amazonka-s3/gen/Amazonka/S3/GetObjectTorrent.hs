...
newGetObjectTorrent pBucket_ pKey_
  = GetObjectTorrent'{expectedBucketOwner =
                        Prelude.Nothing,
                      requestPayer = Prelude.Nothing, bucket = pBucket_,
                      key = pKey_}
...
instance Core.AWSRequest GetObjectTorrent where
        ...
        response
          = Response.receiveBody
              (\ s h x ->
                 GetObjectTorrentResponse' Prelude.<$>
...
newGetObjectTorrentResponse pHttpStatus_ pBody_
  = GetObjectTorrentResponse'{requestCharged =
                                Prelude.Nothing,
