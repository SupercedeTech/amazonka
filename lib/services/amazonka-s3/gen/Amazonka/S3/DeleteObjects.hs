...
newDeleteObjects pBucket_ pDelete_
  = DeleteObjects'{checksumAlgorithm = Prelude.Nothing,
                   expectedBucketOwner = Prelude.Nothing,
                   requestPayer = Prelude.Nothing,
                   bypassGovernanceRetention = Prelude.Nothing,
                   mfa = Prelude.Nothing, bucket = pBucket_,
                   delete' = pDelete_}
...
instance Core.AWSRequest DeleteObjects where
        type AWSResponse DeleteObjects =
             DeleteObjectsResponse
        request srv
          = Request.contentMD5Header Prelude..
              Request.s3vhost Prelude.. Request.postXML srv
        response
          = Response.receiveXML
              (\ s h x ->
                 DeleteObjectsResponse' Prelude.<$>
                   (h Core..#? "x-amz-request-charged") Prelude.<*>
                     (Core.may (Core.parseXMLList "Deleted") x)
                ...
                Prelude.rnf requestPayer `Prelude.seq`
                  Prelude.rnf bypassGovernanceRetention `Prelude.seq`
                    Prelude.rnf mfa `Prelude.seq`
                      Prelude.rnf bucket `Prelude.seq` Prelude.rnf delete'
...
newDeleteObjectsResponse pHttpStatus_
  = DeleteObjectsResponse'{requestCharged =
                             Prelude.Nothing,
                           deleted = Prelude.Nothing, errors = Prelude.Nothing,
