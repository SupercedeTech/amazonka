...
instance Core.AWSService PutBucketPolicy where
              ...
              Prelude.rnf contentMD5 `Prelude.seq`
                Prelude.rnf expectedBucketOwner `Prelude.seq`
                  Prelude.rnf confirmRemoveSelfBucketAccess
                    `Prelude.seq`
                    Prelude.rnf bucket `Prelude.seq` Prelude.rnf policy
          ...
          = Prelude.mconcat
              ["x-amz-sdk-checksum-algorithm" Core.=#
               ...
               "x-amz-expected-bucket-owner" Core.=#
                 expectedBucketOwner,
               "x-amz-confirm-remove-self-bucket-access" Core.=#
