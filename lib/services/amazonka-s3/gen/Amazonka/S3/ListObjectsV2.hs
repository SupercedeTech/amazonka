...
newListObjectsV2 pBucket_
  = ListObjectsV2'{maxKeys = Prelude.Nothing,
                   ...
                   encodingType = Prelude.Nothing, bucket = pBucket_}
...
instance Core.AWSPager ListObjectsV2 where
        page rq rs
          | Core.stop
              (rs Lens.^?
                 listObjectsV2Response_isTruncated Prelude..
                   Lens._Just)
            = Prelude.Nothing
          | Prelude.isNothing
              (rs Lens.^?
                 listObjectsV2Response_nextContinuationToken Prelude..
                   Lens._Just)
            = Prelude.Nothing
          | Prelude.otherwise =
            Prelude.Just Prelude.$ rq Prelude.&
              listObjectsV2_continuationToken Lens..~
                rs Lens.^?
                  listObjectsV2Response_nextContinuationToken Prelude..
                    Lens._Just
...
instance Core.AWSRequest ListObjectsV2 where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListObjectsV2Response' Prelude.<$>
                   (x Core..@? "MaxKeys") Prelude.<*>
                     (Core.may (Core.parseXMLList "CommonPrefixes") x)
                     Prelude.<*> (x Core..@? "StartAfter")
                     Prelude.<*> (x Core..@? "Name")
                     Prelude.<*> (x Core..@? "KeyCount")
                     Prelude.<*>
                     (Core.may (Core.parseXMLList "Contents") x)
        ...
        toQuery ListObjectsV2'{..}
          = Prelude.mconcat
              ["max-keys" Core.=: maxKeys,
               ...
               "prefix" Core.=: prefix,
               "encoding-type" Core.=: encodingType, "list-type=2"]
...
newListObjectsV2Response pHttpStatus_
  = ListObjectsV2Response'{maxKeys = Prelude.Nothing,
                           commonPrefixes = Prelude.Nothing,
                           startAfter = Prelude.Nothing, name = Prelude.Nothing,
