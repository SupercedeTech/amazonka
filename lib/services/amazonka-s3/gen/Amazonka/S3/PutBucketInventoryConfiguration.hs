...
newPutBucketInventoryConfiguration
    ...
    -> InventoryConfiguration -- ^ 'inventoryConfiguration'
    -> PutBucketInventoryConfiguration
newPutBucketInventoryConfiguration pBucket_ pId_
  pInventoryConfiguration_
  = PutBucketInventoryConfiguration'{expectedBucketOwner
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           PutBucketInventoryConfiguration
         where
        type AWSResponse PutBucketInventoryConfiguration =
             PutBucketInventoryConfigurationResponse
        request srv
...
instance Core.ToPath PutBucketInventoryConfiguration
         where
        toPath PutBucketInventoryConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery PutBucketInventoryConfiguration
         where
