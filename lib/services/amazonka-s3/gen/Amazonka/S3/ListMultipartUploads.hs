...
newListMultipartUploads pBucket_
  = ListMultipartUploads'{expectedBucketOwner =
                            Prelude.Nothing,
...
instance Core.AWSPager ListMultipartUploads where
        page rq rs
          | Core.stop
              (rs Lens.^?
                 listMultipartUploadsResponse_isTruncated Prelude..
                   Lens._Just)
            = Prelude.Nothing
          | Prelude.isNothing
              (rs Lens.^?
                 listMultipartUploadsResponse_nextKeyMarker Prelude..
                   Lens._Just)
              Prelude.&&
              Prelude.isNothing
                (rs Lens.^?
          ...
          | Prelude.otherwise =
            Prelude.Just Prelude.$ rq Prelude.&
              listMultipartUploads_keyMarker Lens..~
                rs Lens.^?
                  listMultipartUploadsResponse_nextKeyMarker Prelude..
                    Lens._Just
              Prelude.&
              listMultipartUploads_uploadIdMarker Lens..~
                rs Lens.^?
                  listMultipartUploadsResponse_nextUploadIdMarker
                    Prelude.. Lens._Just
...
instance Core.AWSRequest ListMultipartUploads where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListMultipartUploadsResponse' Prelude.<$>
        ...
        toQuery ListMultipartUploads'{..}
          = Prelude.mconcat
              ["max-uploads" Core.=: maxUploads,
               ...
               "encoding-type" Core.=: encodingType, "uploads"]
