...
newGetBucketAnalyticsConfiguration pBucket_ pId_
  = GetBucketAnalyticsConfiguration'{expectedBucketOwner
                                       = Prelude.Nothing,
...
instance Core.AWSRequest
           GetBucketAnalyticsConfiguration
         where
        type AWSResponse GetBucketAnalyticsConfiguration =
             GetBucketAnalyticsConfigurationResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketAnalyticsConfigurationResponse' Prelude.<$>
...
instance Core.ToPath GetBucketAnalyticsConfiguration
         where
        toPath GetBucketAnalyticsConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery GetBucketAnalyticsConfiguration
         where
