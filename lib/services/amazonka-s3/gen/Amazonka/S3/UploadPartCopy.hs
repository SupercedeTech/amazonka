...
newUploadPartCopy
    ...
    -> ObjectKey -- ^ 'key'
    -> Prelude.Int -- ^ 'partNumber'
    -> Prelude.Text -- ^ 'uploadId'
    -> UploadPartCopy
newUploadPartCopy pBucket_ pCopySource_ pKey_
  pPartNumber_ pUploadId_
  = UploadPartCopy'{copySourceIfNoneMatch =
                      Prelude.Nothing,
                    ...
                    partNumber = pPartNumber_, uploadId = pUploadId_}
...
instance Core.AWSRequest UploadPartCopy where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 UploadPartCopyResponse' Prelude.<$>
...
newUploadPartCopyResponse pHttpStatus_
  = UploadPartCopyResponse'{serverSideEncryption =
                              Prelude.Nothing,
