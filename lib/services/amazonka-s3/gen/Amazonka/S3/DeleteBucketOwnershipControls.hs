...
newDeleteBucketOwnershipControls pBucket_
  = DeleteBucketOwnershipControls'{expectedBucketOwner
                                     = Prelude.Nothing,
                                   bucket = pBucket_}
...
instance Core.AWSRequest
           DeleteBucketOwnershipControls
         where
        type AWSResponse DeleteBucketOwnershipControls =
             DeleteBucketOwnershipControlsResponse
        request srv
...
instance Core.ToHeaders DeleteBucketOwnershipControls
         where
...
instance Core.ToPath DeleteBucketOwnershipControls
         where
        toPath DeleteBucketOwnershipControls'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery DeleteBucketOwnershipControls
         where
        toQuery
          = Prelude.const
