...
instance Core.AWSRequest ListBuckets where
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 ListBucketsResponse' Prelude.<$>
                   (x Core..@? "Owner") Prelude.<*>
                     (x Core..@? "Buckets" Core..!@ Prelude.mempty
...
newListBucketsResponse pHttpStatus_
  = ListBucketsResponse'{owner = Prelude.Nothing,
                         buckets = Prelude.Nothing, httpStatus = pHttpStatus_}
