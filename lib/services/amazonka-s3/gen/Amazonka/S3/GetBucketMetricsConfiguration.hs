...
newGetBucketMetricsConfiguration pBucket_ pId_
  = GetBucketMetricsConfiguration'{expectedBucketOwner
                                     = Prelude.Nothing,
...
instance Core.AWSRequest
           GetBucketMetricsConfiguration
         where
        type AWSResponse GetBucketMetricsConfiguration =
             GetBucketMetricsConfigurationResponse
        request srv
        ...
        response
          = Response.receiveXML
              (\ s h x ->
                 GetBucketMetricsConfigurationResponse' Prelude.<$>
...
instance Core.ToHeaders GetBucketMetricsConfiguration
         where
...
instance Core.ToPath GetBucketMetricsConfiguration
         where
        toPath GetBucketMetricsConfiguration'{..}
          = Prelude.mconcat ["/", Core.toBS bucket]

instance Core.ToQuery GetBucketMetricsConfiguration
         where
